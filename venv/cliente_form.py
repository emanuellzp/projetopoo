...
class Ui_cliente(object):
    def setupUi(self, cliente):
        ...
        self.frame_titulo.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 188, 0, 255), stop:1 rgba(255, 255, 255, 255));")
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 188, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.label_infos = QtWidgets.QLabel(parent=self.frame_rodape)
        self.label_infos.setGeometry(QtCore.QRect(0, 0, 640, 80))
        self.label_infos.setMinimumSize(QtCore.QSize(640, 80))
        self.label_infos.setMaximumSize(QtCore.QSize(640, 80))
        font = QtGui.QFont()
        font.setPointSize(23)
        font.setBold(True)
        self.label_infos.setFont(font)
        self.label_infos.setStyleSheet("")
